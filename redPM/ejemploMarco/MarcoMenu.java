...
public class MarcoMenu extends JFrame{
	...
	private JRadioButtonMenuItem elementosColores[]; // elementos del menu colores.
	private JRadioButtonMenuItem fuentes[]; // elementos del menu fuentes.
	...
	public MarcoMenu(){
		...
		fuentes[ 0 ].setSelected( true ); // selecciona el primer elemento del menú Fuentes
